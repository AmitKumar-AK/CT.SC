namespace CT.SC.Foundation.SitecoreExtensions.Extensions
{
    ...
    public static class RenderingExtensions
    {
        ...
        {
            return MainUtil.GetBool(rendering.Parameters[CT.SC.Foundation.SitecoreExtensions.Constants.DynamicPlaceholdersLayoutParameters.UseStaticPlaceholderNames], false);
        }
    }
}